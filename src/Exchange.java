...
public class Exchange {
    ...
    public static List<Calling> peopleThreads;
    public static HashMap<String, Calling> threadHM = new HashMap<>();
    ...
    public static void main(String[] args) {
        ...
        if (userList.size() > 0){
            ...
            for(String data : userList){
                ...
                Calling tmpThread = new Calling(tmpUser);
    ...
    public void printIntroInMaster(String msg, int time) {
        System.out.println(msg + " [" + time+ "]");
    }
    public void printReplyInMaster(String msg, int time) {
        System.out.println(msg + " [" +  (time)  + "]");
    }
